...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_json_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7a1ad169-5d6d-5d19-843c-e04c00abb03b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter_json", artifacts_toml) for e in artifacts["tree_sitter_json"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter_json; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module tree_sitter_json_jll
